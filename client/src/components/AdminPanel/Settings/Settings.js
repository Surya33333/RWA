          ...
          {!usertoken ? (<Login />) : (
            <div className="flex w-[100%]">
              ...
              <div className="settingsContainer flex-1">
                ...
                <div className={` ${open ? 'h-[200px]' : 'h-[100px]'} duration-300 bg-white shadow-lg m-[10px] rounded-md p-[10px]`}>
                  <div className="resetpassword flex justify-between m-[10px] rounded-md p-[10px]">
                    ...
                    <div className="bg-green-500 mt-1  text-slate-100 shadow-md hover:translate-x-1 hover:scale-105 cursor-pointer rounded-xl font-bold p-2" onClick={()=>{setChangePasswordTab(!open)}}>{!open ? "Change Password" : "Close"}</div>
                  </div>
                  <div>
                  <form>
                  <div className={`flex justify-evenly gap-2 ${open ? '' : 'scale-0'} duration-300`}>
                    <div>
                  ...
                  <div className="m-auto"><p>Update</p></div>
                  </div>
                  </form>
                  </div>
                </div>
